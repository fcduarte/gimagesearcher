...
import com.fcduarte.gimagesearcher.util.SystemUiHider;
...
public class ImageFullscreenActivity extends Activity {
	...
	protected static final String IMAGE_URL_KEY = "image-url-key";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Picasso.with(this).load(url).fit().into(contentView);
	}
